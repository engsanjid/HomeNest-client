      ...
      <div className="max-w-7xl mx-auto px-6 py-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            ...
            <li><Link to="/all-properties" className="hover:text-primary transition-colors">All Properties</Link></li>
            <li><Link to="/add-property" className="hover:text-primary transition-colors">Add Property</Link></li>
            <li><Link to="/my-properties" className="hover:text-primary transition-colors">My Properties</Link></li>
            <li><Link to="/my-ratings" className="hover:text-primary transition-colors">My Ratings</Link></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            <li>Email: <a href="mailto:info@homenest.com" className="hover:text-primary">mdsanjidi36@gmail.com</a></li>
            <li>Phone: <a href="tel:+8801745532902" className="hover:text-primary">+880 123 456 789</a></li>
        ...
        <div>
          ...
          <div className="flex gap-4 mb-4">
            <a href="https://www.facebook.com/sanjid.sanjid.311" aria-label="Facebook" className="hover:text-primary">
            ...
            <a href="https://www.instagram.com/mdsanjid956/" aria-label="Instagram" className="hover:text-primary">
              <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 fill-current" viewBox="0 0 24 24">
